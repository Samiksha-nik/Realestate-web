    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="w-full h-[380px] overflow-hidden">
        <iframe
          ...
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3770.9093377855534!2d72.82760107496!3d19.05865258214!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c94cd3af0ccb%3A0xeed7ce78f1c5e9e!2sBandra%20West%2C%20Mumbai%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin"
          width="100%"
          height="100%"
            ...
            <div className="lg:col-span-2 bg-obsidian-lighter p-8 lg:p-10 border border-border/50 rounded-b-2xl lg:rounded-bl-none lg:rounded-r-2xl flex flex-col">
              ...
              <div className="space-y-6 flex-1">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground text-sm leading-relaxed">Bandra West,<br />Mumbai, Maharashtra – India</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground text-sm">info@ananyarealty.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground text-sm">www.ananyarealty.com</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-10 pt-6 border-t border-border/30">
                <div className="flex items-center gap-3">
                  <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-secondary border border-border/50 flex items-center justify-center hover:bg-primary hover:border-primary hover:text-primary-foreground text-muted-foreground transition-all duration-300">
                    <Facebook className="w-3.5 h-3.5" />
                  </a>
                  <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-secondary border border-border/50 flex items-center justify-center hover:bg-primary hover:border-primary hover:text-primary-foreground text-muted-foreground transition-all duration-300">
                    <Instagram className="w-3.5 h-3.5" />
                  </a>
                  <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-secondary border border-border/50 flex items-center justify-center hover:bg-primary hover:border-primary hover:text-primary-foreground text-muted-foreground transition-all duration-300">
                    <Linkedin className="w-3.5 h-3.5" />
                  </a>
                  <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-secondary border border-border/50 flex items-center justify-center hover:bg-primary hover:border-primary hover:text-primary-foreground text-muted-foreground transition-all duration-300">
